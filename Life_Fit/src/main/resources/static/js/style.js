...
(function() {
  $(function() {
    $(".temhabank-N1[id=\'fFMd5L2SV0\']").each(function() {
      const $block = $(this);
...
(function() {
  $(function() {
    $(".temhabank-N4[id=\'iWMD5L2T78\']").each(function() {
      const $block = $(this);
      // Swiper
      ...
      const swiper = new Swiper(".temhabank-N4[id=\'iWMD5L2T78\'] .swiper", {
        slidesPerView: 1,
        spaceBetween: 0,
        loop: true,
        autoplay: {
        ...
        navigation: {
          nextEl: ".temhabank-N4[id=\'iWMD5L2T78\'] .btn-next",
          prevEl: ".temhabank-N4[id=\'iWMD5L2T78\'] .btn-prev",
        },
      });
      // 정지
...
(function() {
  $(function() {
    $(".temhabank-N6[id=\'NTMd5l2tFS\']").each(function() {
      const $block = $(this);
